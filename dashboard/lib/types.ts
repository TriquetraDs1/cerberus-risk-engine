...
export interface QueueTransaction {
  ...
  // A1: plain-English narration of this row's decision, generated by
  // scripts/export_dashboard_data.py from the fields above (LLM if a key is set, a
  // deterministic template otherwise). Optional so older queue.json still type-checks.
  explanation?: string;
}
